...
class _ListBanquetState extends State<ListBanquet> {
  ...
  late String _banqname,_streetno,_streetname,_district,_pincode,_state,_contact;
  late int _hygienerate;
  Future _uploadData()async{
    try{
      var _uid = Uuid().v1();
      await FirebaseFirestore.instance.collection('banquet-record').doc(_uid).set({
          'banquetname' : _banqname,
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children:[
                        //Banquet Name
                        TextFormField(
                          decoration: inputfield.copyWith(labelText:"Banquet Name"),
                          validator: (val){
                            if(val!.isEmpty){
