    ...
    try {
      await FirebaseFirestore.instance.collection('caterer-record').doc().set({
        ...
        'address': _streetno +
            ...
            ", " +
            _state,
        'searchcases': setSearchParam(_catname),
      });
      return 'success';
    } catch (e) {
      return e;
                  ...
                  child: Form(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            decoration:
                                inputfield.copyWith(labelText: "Caterer Name"),
                            validator: (val) {
                              if (val!.isEmpty) {
                              ...
                              Expanded(
                                ...
                                child: TextFormField(
                                  decoration: inputfield.copyWith(
                                      labelText: "Serve(veg/nonveg/both)"),
                                  validator: (val) {
                                    if (val!.isEmpty) {
                                      return "Enter Serve";
                          ...
                          TextFormField(
                            decoration:
                                inputfield.copyWith(labelText: "Street Name"),
                            validator: (val) =>
                                (val!.isEmpty) ? "Enter Street Name" : null,
                            onChanged: (val) {
                              setState(() {
                                _streetname = val;
                              });
                          ...
                          TextFormField(
                            decoration:
                                inputfield.copyWith(labelText: "Special Item"),
                            onChanged: (val) {
                              setState(() {
                                _specialitem = val;
                              });
